...
import { db } from "../firebase"; // Importez votre configuration Firestore
    ...
    async function onSubmit(e) {
        ...
        try {
            if (password === confirmPassword) {
                ...
                delete formDataCopy.password; // Ne pas stocker le mot de passe en texte clair
            ...
            console.error("Something went wrong with the registration", error);
        ...
        <div className="bg-gradient-to-tl from-blue-900 to-black pb-10 px-28 max-[750px]:px-16 max-[650px]:px-10 pt-20 flex items-center justify-center">
            <div className="bg-blue-950 w-[800px] h-[500px] rounded-xl mt-10 shadow shadow-slate-800 flex overflow-hidden">
                <div className="w-1/2 max-[530px]:w-full flex flex-col justify-between items-center text-white py-5">
                    ...
                    <form className="w-full px-5 flex flex-col gap-5 justify-center" onSubmit={onSubmit}>
                        ...
                        <input type="password" placeholder="Password" value={password} onChange={onChange} id="password" className="bg-transparent border-b-[1px] w-full text-[13px] focus:outline-none py-3" />
                        <input type="password" placeholder="Confirm Password" value={confirmPassword} onChange={onChange} id="confirmPassword" className="bg-transparent border-b-[1px] w-full text-[13px] focus:outline-none py-3" />
